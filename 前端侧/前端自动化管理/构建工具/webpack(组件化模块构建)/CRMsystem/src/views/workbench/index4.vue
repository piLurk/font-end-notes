    ...
    <div class="workbench-content" :class="{longWidth : !sidebar.opened}">
      ...
      <div class="middle">
          ...
          <div class="salesBrief">
            ...
            <div class="saleItems">
                <div class="item">
                    ...
                    <div class="businessNumb"><span>线索量</span><div class="right"><span id="">{{briefList.followPersonCount}}</span><span>个</span></div></div>
        ...
        <div class="inOut" :class="{longWidth : !sidebar.opened}">
          <div class="title"><i></i><span>出房完成情况</span></div>
          <div class="outDataItems">
              <div class="item" v-for="(item,i) in rentAchievementList" :key="i">
                  <div class="mouth">{{item.month}}</div>
                  <div class="right">
                    <div class="outTotle">出房总量<span>{{item.compeletNum}}</span>间</div>
