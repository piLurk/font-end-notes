<template>
  <div class="noticeList">
    ...
    <div class="table-box">
      <div v-if="true" class="fl table-top-box">
        <router-link ref='tag'
          ...
          <table class="modtable">
            ...
            <tbody>
              <tr v-for="(item, index) in questionList" :key="index">
                ...
                <td>
                  <router-link v-if="hasPermission('cms_question_edit')" ref='tag'
                  ...
                  <span v-if="hasPermission('cms_question_delete')" class="edit operate" @click="deleteQuestion(item)">
