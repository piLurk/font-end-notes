<template>
  <div class="noticeList">
    <div class="table-box">
      <div v-if="hasPermission('cms_category_add')"  class="fl table-top-box">
          ...
          <table class="modtable">
            ...
            <tbody>
              <tr v-for="(item, index) in questionTypeList" :key="index">
                <td>{{item.typeName}}</td>
                <td>
                  <span v-if="hasPermission('cms_category_edit')" class="edit operate" @click="editQaType(item)">
                    <i class="el-icon-edit"></i>
                    编辑
                  </span>
                  <span v-if="hasPermission('cms_qatype_stop')" class="edit operate" @click="deleteQuestion(item)">
                    <el-switch
